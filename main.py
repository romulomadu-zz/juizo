...
def fit_filename(text):	
    '''
    Fit link name as file name.

    Parameters
    ----------
    text : str
        Link name which will be changed to fit as file name.
        
    Returns
    ----------
    str
        String with file name fitted.
...
def fit_text(text):
    '''
    Fit original columns name to column name that will be stored in db.

    Parameters
    ----------
    text : str 
        Column name which will be changed to fit as db column.
        
    Returns
    ----------
    str
        TString with columns name fitted
...
if __name__ == "__main__":
    ...
    # Fit labels as they will be stored in db
